...
Входные данные содержат два целых числа $a, b$ $(-10^9 \leq a, b \leq 10^9)$.
...
Входные данные содержат два целых числа $a, b$ $(1 \leq a, b \leq 1000)$ - длины сторон прямоугольника.
...
Входные данные содержат единственное целое число $a$ $(1 \leq a \leq 10^3)$ - длину ребра куба.
...
В единственной строке находится число $k$ $(0 \leq k \leq 10^9)$ - количество вещей, которые гномы хотят поделить.
...
В единственной строке входных данных содержится два целых числа $a, b$ $(1 \leq a, b \leq 10^9)$.
...
Входные данные содержат два целых числа $a, b$ $(0 \leq a, b \leq 9 \cdot 10^{18})$ - длины сторон прямоугольника.
...
Входные данные содержат два целых числа $a, b$ $(-10^{18} \leq a \leq 10^{18}; 0 < b \leq 10^{18})$ - длины сторон прямоугольника.
...
Входные данные содержат единственное неотрицательное число, по модулю не превосходящее $10^{18}$.
...
Входные данные содержат единственное целое число $a$ $(32 \leq a \leq 126)$.
...
Входные данные содержат единственное целое число $i$ $(1 \leq i \leq 26)$.
...
Входные данные содержат единственное целое число $a$ $(0 \leq a \leq 10^{100})$.
...
Входные данные содержат число $n$ $(0 \leq n \leq 15)$ - количество знаков после запятой, которое необходимо вывести.
...
Входные данные содержат два целых числа $a, b$ $(−10^9 < a, b < 10^9; b \ne 0)$.

#### Выходные данные

Выведите результат деления $\frac{a}{b}$. Ответ будет считаться верным, если абсолютная или относительная погрешность не больше $10^{−6}$.
...
Входные данные содержат два целых числа $a, b$ $(-10^9 \leq a, b \leq 10^9; b \ne 0)$. 
...
Входные данные содержат единственное целое число, по модулю не превосходящее $10^{18}$.
...
Входные данные содержат 5 целых чисел, каждое по модулю не превосходит $10^9$.
